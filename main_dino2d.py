...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='/media/johannes/WD Elements/DINO-Glioblastoma-SSL/data/tiny-imagenet-200/train/', type=str,
...
def train_dino(args):
    ...
    if args.arch in vits.__dict__.keys():
        ...
        student = monai.networks.nets.DenseNet121(spatial_dims=3, in_channels=1, out_channels=0).features
        teacher = monai.networks.nets.DenseNet121(spatial_dims=3, in_channels=1, out_channels=0).features
        embed_dim = student[-1].num_features
